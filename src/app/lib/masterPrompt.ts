...
export function compileMasterPrompt(form: FormData, narrationWPM: number = 165): string {
  ...
  // Multi-Reference Image berbasis TEKS — independen dari referencePhotos upload (sekarang tidak dipakai).
  ...
  "scenes": [
    {
      ...
      "ai_ready_prompt": "WAJIB DIISI, string, max ${charLimit} karakter. ${(form.aiTool === 'google_flow' || form.aiTool === 'veo3')
